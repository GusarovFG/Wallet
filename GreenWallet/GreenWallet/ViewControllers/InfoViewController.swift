...
class InfoViewController: UIViewController {
    ...
    private func localization() {
        ...
        self.textView.text = LocalizationManager.share.translate?.result.list.about_the_application.about_the_application_info
    }
